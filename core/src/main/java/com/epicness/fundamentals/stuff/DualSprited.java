...
public class DualSprited implements Buttonable, Transformable {
    ...
    public final Sprited background, foreground;
    ...
    public void setOriginX(float x) {
        background.setOriginX(x);
        foreground.setOriginX(x);
    }

    public void setOriginY(float y) {
        background.setOriginY(y);
        foreground.setOriginY(y);
    }
    ...
    public void useBilinearFilter() {
        background.useBilinearFilter();
        foreground.useBilinearFilter();
    }
}